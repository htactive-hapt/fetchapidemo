    ...
    render() {
        ...
        return (
            <div className="why-choose-us-container">
                ...
                <Row className='autoplay-footer'>
                    <Col span={4}>
                    </Col>
                    <Col span={8}>
                        <Carousel className="carousel-autoplay" {...options}>
                            {this.state.slides.map(function (slide, index) {
                                return (
                                    <div key={index}>
                                        <img className="img-carousel" src={slide} alt='' />
                                    </div>
                                );
                            })}
                        </Carousel>
                    ...
                    <Row className="quote-container">
                        ...
                        <p className="quote-string">Design is not just what it looks like and feels like.
                         Design is how it works.</p>
                        <cite className="steve-jobs" title="Source Title">_ Steve Jobs </cite>
                    </Row>
                </Row>
            </div>
        )
